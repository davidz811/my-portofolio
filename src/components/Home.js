  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
        ...
        <div className='max-w-[1000px] w-full h-full mx-auto px-8 flex flex-col justify-center text-white'>
          ...
          <p className='text-[25px] text-[#8892b0] py-4 max-w-[700px]'>I'm a Front-End Developer focused on developing great applications. Let's transform your digital vision into reality!</p>
          <div>
          <Link
                  to="work"
                  smooth={true}
